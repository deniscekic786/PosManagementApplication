<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="EmployeeMngmt.aspx.vb" Inherits="Project5.EmployeeMngmt" %>
...
<tr>
<td style="width: 128px; height: 26px; text-align: right"> <strong>SSN</strong></td>
...
<td style="width: 342px; height: 26px"> 
    <asp:TextBox ID="txtaddre" runat="server" 
        Width="206px"></asp:TextBox></td>
<td style="width: 17px; height: 26px">
</td>
...
<tr>
<td style="width: 128px; height: 26px; text-align: right"> Phone Number</td>
<td style="width: 18px; height: 26px">
</td>
<td style="width: 342px; height: 26px">
<asp:TextBox ID="txtpnum" runat="server" Width="210px"></asp:TextBox></td>
<td style="width: 17px; height: 26px">
</td>
...
<td style="width: 342px; height: 21px">
<asp:TextBox ID="txtema" runat="server" Width="210px"></asp:TextBox>
</td>
<td style="width: 17px; height: 21px">
</td>
<td style="width: 148px; height: 21px">
...
<td style="width: 342px; height: 21px">
<asp:TextBox ID="txtJobtitle" runat="server" Width="210px"></asp:TextBox>
</td>
<td style="width: 17px; height: 21px">
</td>
<td style="width: 148px; height: 21px">
